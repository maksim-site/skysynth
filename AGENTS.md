...
- Gallery orientation correction, 23.08.2026: a speed-ramp switch always starts from the canonical gallery camera, independently of any manual OrbitControls angle. Reset the controls before the transition begins, never at the mid-ramp GLB swap, so left/right direction stays deterministic and the camera cannot jump under the blur.
